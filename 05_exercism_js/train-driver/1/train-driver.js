...
export function fixListOfWagons(ids) {
  const [firstEle,secondEle,...restEle] = ids;
  restEle.push(firstEle);
  restEle.push(secondEle)
  return restEle;
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [firstId,...restId] = ids;
  console.log(firstId,...missingWagons,...restId);
  // console.log(firstId,missingWagons,restId);
  return [firstId,...missingWagons,...restId];
}
